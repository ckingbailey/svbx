...
$context['data']['system'] = $link->
  ...
  get('CDL', null, ['systemName', 'COUNT(CDL.groupToResolve) as count', 'CONCAT(SUBSTR(firstname, 1, 2), " ", lastname) as lead']);
...
// $twig->display('dashboard.html.twig', [
