/* deficiency view add certifiable element stuff UP */
CREATE OR REPLACE VIEW deficiency AS
    ...
    safety.yesNoName safetyCert,
    CDL.certElID certElID,
    CDL.CEID_PDCC CEID_PDCC,
    repo.repoName repo,
    ...
    LEFT JOIN yesNo safety ON CDL.safetyCert = safety.YesNoID
